...
\begin{minipage}{0.38\textwidth}
    \scalebox{0.63}{\input{Figures/Seven.Factors.tex}}
\end{minipage}
\end{frame}
...
\begin{frame}{Chemical Reactor Control System}
    \resizebox{\textwidth}{!}{\input{Figures/Architecture.of.Cybersecurity.Decision-making.tex}}
\end{frame}
...
\begin{frame}{Common Classes}
    ...
    \resizebox{\textwidth}{!}{\input{Figures/Common.Classes.tex}}
\end{frame}
...
\begin{minipage}[t]{0.4\textwidth}
    ...
    \centering
    \input{Figures/Bayesian.Network.Example.tex}
...
\begin{frame}{Chemical Reactor Control System}
    \hspace{-10pt}\resizebox{\textwidth}{!}{\input{Figures/Structure.of.Chemical.Reactor.Control.System.tex}}
\end{frame}
