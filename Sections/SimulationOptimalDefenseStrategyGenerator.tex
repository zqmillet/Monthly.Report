...
\begin{frame}{Decision-Making Detail 1}
  ...
  \begin{center}
    \scalebox{1}{
    \input{./Tables/DecisionMakingDetaila01a02}
    }
  \end{center}
  \end{overlayarea}
\end{frame}
...
\begin{frame}{Decision-Making Detail 2}
  ...
  \begin{center}
    \scalebox{0.7}{
    \input{./Tables/DecisionMakingDetaila01a02a03a08a09a10a25f08HighCost}
    }
  \end{center}
  \end{overlayarea}
\end{frame}
...
\begin{frame}{Decision-Making Detail 3}
  ...
  \begin{center}
    \scalebox{0.7}{
    \input{./Tables/DecisionMakingDetaila01a02a03a08a09a10a25f08LowCost}
    }
  \end{center}
  \end{overlayarea}
\end{frame}