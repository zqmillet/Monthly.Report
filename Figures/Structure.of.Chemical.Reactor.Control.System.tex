...
\newkeycommand{\computer}[x = 0cm, y = 0cm, width = 2cm, height = 2cm, name = computer][1]{
    \node at (\commandkey{x}, \commandkey{y}) {\includegraphics[width=\commandkey{width}]{Figures/Material/Computer.pdf}};
...
\newkeycommand{\server}[x = 0cm, y = 0cm, width = 1.35cm, height = 2cm, name = server][1]{
    \node at (\commandkey{x}, \commandkey{y}) {\includegraphics[width=\commandkey{width}]{Figures/Material/Server.pdf}};
...
\newkeycommand{\plc}[x = 0cm, y = 0cm, width = 1.8cm, height = 2cm, name = plc][1]{
    \node at (\commandkey{x}, \commandkey{y}) {\includegraphics[width=\commandkey{width}]{Figures/Material/PLC.pdf}};
...
\newkeycommand{\gateway}[x = 0cm, y = 0cm, width = 1.8cm, height = 1.5cm, name = gateway][1]{
    \node at (\commandkey{x}, \commandkey{y}) {\includegraphics[width=\commandkey{width}]{Figures/Material/Gateway.pdf}};
